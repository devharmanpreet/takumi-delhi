...
//particles (rising motes of light, more active when world is restored)
...
function restoreWorld() {
  ...
  // Power up all renewables(with a staggered delay for effect)
...
function animate() {
  ...
  // Camera (implementing simple WASD movement and mouse look)
